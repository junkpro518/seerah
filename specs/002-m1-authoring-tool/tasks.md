...
- [ ] T040 [P] [US6] اختبار وحدة: استعلام الاقتراح يُعيد معلومات/مصادر ذات صلة ضمن رؤية الدور في `tests/unit/smart-link.test.ts` — أحمر
- [ ] T041 [US6] اقتراحات الربط الذكي في المحرّر `lib/editor/` + UI. **[blockedBy T040, T030]** — (FR-022)
